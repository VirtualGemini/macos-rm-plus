...
- [x] The decision on exposing Foundation error domain and numeric code is recorded; consumers are explicitly directed to depend only on rmp's stable error codes.
