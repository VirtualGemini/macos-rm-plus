...
final class TestSafetyContext {
  ...
  private static let containerName = "tc-test"
  private static let authorizedRootName = "test"
  private static let containerMarkerName = ".tc-test-container"
  private static let rootMarkerName = ".tc-test-root"
  private static let runMarkerName = ".tc-test-run"
