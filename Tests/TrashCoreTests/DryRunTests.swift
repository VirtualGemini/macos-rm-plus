...
func dryRunApplicationReportsUnknownOptions() {
  ...
  #expect(result.standardError == "tc: unknown option \"--unknown\"\n")
}
...
func dryRunApplicationRejectsEmptyNativeRequest() {
  ...
  #expect(
    result.standardError
      == "tc: no_inputs: --dry-run requires at least one Trash Input\n"
  )
}
...
func dryRunRejectsProtectedPathWithSafetyExitCode() {
  ...
  #expect(
    result.standardError
      == "tc: protected_path (filesystem-root): Protected Path rejected: \"/tmp/..\"\n"
  )
}
