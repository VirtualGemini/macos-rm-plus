...
func emptyInvocationIsUsageError() {
  ...
  #expect(result.standardError == "tc: at least one Trash Input is required\n")
}
...
func helpSurfacesExplainCompatibilityConsistently() {
  ...
  #expect(primary.contains("tc --help -a"))
  ...
  #expect(primaryChinese.contains("tc --help -a -zh"))
