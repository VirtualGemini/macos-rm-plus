...
struct PutBackMetadataScannerTests {
  ...
  func extractsPutBackRecords() {
    let data =
      record(fileName: "tc-test-item", kind: "ptbL", payload: "/Users/test/source")
      + record(fileName: "tc-test-item", kind: "ptbN", payload: "tc-test-item")
